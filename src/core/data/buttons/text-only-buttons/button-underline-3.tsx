...
const DEFAULT_PROPS: ButtonUnderline3Props = {
  label: 'Hover Me',
...
const AFTER_CLASS =
  'after:absolute after:bottom-[-2px] after:left-0 after:w-full after:opacity-100 after:transition-opacity hover:after:opacity-0'

export const ButtonUnderline3 = ({
...
export const getButtonUnderline3Source = ({
  label = DEFAULT_PROPS.label,
  textColor = DEFAULT_PROPS.textColor,
  underlineColor = DEFAULT_PROPS.underlineColor,
  underlineHeight = DEFAULT_PROPS.underlineHeight,
